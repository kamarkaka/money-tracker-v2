...
export function MonthlySummaryHeader({ totalIncome, totalExpenses }: MonthlySummaryHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
      ...
      <div className={`col-span-2 rounded-lg border px-4 py-4 text-center md:col-span-1 md:px-4 md:py-4 ${
        netSavings >= 0
        ...
        <p className="mt-1 flex items-center justify-center text-3xl font-bold md:text-2xl">
          <SlotNumber
